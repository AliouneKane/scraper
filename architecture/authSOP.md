...
4. **Redirect URLs in Supabase Dashboard** — Must include the production URL with wildcard: `https://scraper-chi-tan.vercel.app/**` AND preview URLs: `https://*-alioune-kanes-projects.vercel.app/**`.
